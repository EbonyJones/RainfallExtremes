...
Note: some of the needed functionality is still in development and needs to be downloaded directly from github, details will be provided below.

# Outline:

#### How to install the rnoaa stuff (from github)
